...
# Создание меню
background_image = pygame.image.load("gamedamn\menubg\menu3.png")
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            quit_button_pos[1] <= mouse_pos[1] <= quit_button_pos[1] + quit_button_image.get_height() and start == 0:
                # Quit the game
                running = False
                pygame.quit()
                sys.exit()
    ...
    if start == 1:
        ...
        screen.blit(font.render("Score " + str(wave), 1, (255,0,0)), (600,50))
        clock.tick(60)
